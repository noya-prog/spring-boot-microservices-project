...
public class OrderPlacedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2465249686499111520L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderPlacedEvent\",\"namespace\":\"com.noya.microservices.order.event\",\"fields\":[{\"name\":\"orderNumber\",\"type\":\"string\"},{\"name\":\"email\",\"type\":\"string\"},{\"name\":\"firsName\",\"type\":\"string\"},{\"name\":\"lastName\",\"type\":\"string\"}]}");
  ...
  private java.lang.CharSequence firsName;
   ...
   * @param firsName The new value for firsName
   * @param lastName The new value for lastName
   */
  public OrderPlacedEvent(java.lang.CharSequence orderNumber, java.lang.CharSequence email, java.lang.CharSequence firsName, java.lang.CharSequence lastName) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: firsName = (java.lang.CharSequence)value$; break;
  ...
  /**
   * Gets the value of the 'firsName' field.
   * @return The value of the 'firsName' field.
   */
  public java.lang.CharSequence getFirsName() {
    return firsName;
  }


  /**
   * Sets the value of the 'firsName' field.
   * @param value the value to set.
   */
  public void setFirsName(java.lang.CharSequence value) {
    this.firsName = value;
  }
   ...
   */
  public static com.noya.microservices.order.event.OrderPlacedEvent.Builder newBuilder() {
    return new com.noya.microservices.order.event.OrderPlacedEvent.Builder();
  }
   ...
   * @return A new OrderPlacedEvent RecordBuilder
   */
  public static com.noya.microservices.order.event.OrderPlacedEvent.Builder newBuilder(com.noya.microservices.order.event.OrderPlacedEvent.Builder other) {
    if (other == null) {
      return new com.noya.microservices.order.event.OrderPlacedEvent.Builder();
    } else {
      return new com.noya.microservices.order.event.OrderPlacedEvent.Builder(other);
    }
  }
   ...
   * @return A new OrderPlacedEvent RecordBuilder
   */
  public static com.noya.microservices.order.event.OrderPlacedEvent.Builder newBuilder(com.noya.microservices.order.event.OrderPlacedEvent other) {
    if (other == null) {
      return new com.noya.microservices.order.event.OrderPlacedEvent.Builder();
    } else {
      return new com.noya.microservices.order.event.OrderPlacedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderPlacedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.noya.microservices.order.event.OrderPlacedEvent.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[2], other.firsName)) {
        this.firsName = data().deepCopy(fields()[2].schema(), other.firsName);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.noya.microservices.order.event.OrderPlacedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.orderNumber)) {
        this.orderNumber = data().deepCopy(fields()[0].schema(), other.orderNumber);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.noya.microservices.order.event.OrderPlacedEvent.Builder setOrderNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.noya.microservices.order.event.OrderPlacedEvent.Builder clearOrderNumber() {
      orderNumber = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.noya.microservices.order.event.OrderPlacedEvent.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.noya.microservices.order.event.OrderPlacedEvent.Builder clearEmail() {
      email = null;
    ...
    /**
      * Sets the value of the 'firsName' field.
      * @param value The value of 'firsName'.
      * @return This builder.
      */
    public com.noya.microservices.order.event.OrderPlacedEvent.Builder setFirsName(java.lang.CharSequence value) {
    ...
    /**
      * Checks whether the 'firsName' field has been set.
      * @return True if the 'firsName' field has been set, false otherwise.
      */
    public boolean hasFirsName() {
      return fieldSetFlags()[2];
    }


    /**
      * Clears the value of the 'firsName' field.
      * @return This builder.
      */
    public com.noya.microservices.order.event.OrderPlacedEvent.Builder clearFirsName() {
      firsName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.noya.microservices.order.event.OrderPlacedEvent.Builder setLastName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.noya.microservices.order.event.OrderPlacedEvent.Builder clearLastName() {
      lastName = null;
    ...
    public OrderPlacedEvent build() {
      try {
        ...
        record.firsName = fieldSetFlags()[2] ? this.firsName : (java.lang.CharSequence) defaultValue(fields()[2]);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.firsName = in.readString(this.firsName instanceof Utf8 ? (Utf8)this.firsName : null);
